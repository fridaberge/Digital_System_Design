...
entity pdm1 is
    ...
    port(
        ...
        duty_cycle, min_off, min_on, max_on : in std_logic_vector(WIDTH-1 downto 0)
    );
end entity pdm1;

architecture rtl of pdm1 is
    constant max : unsigned(WIDTH-1 downto 0) :=(others=>'1');

    type statetype is (forward_idle, forward, reverse_idle, reverse);
